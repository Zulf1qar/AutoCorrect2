...
class Config {
    ...
    ; UI Settings
    static DefaultFontSize := "s11" ; At iniRead, gets replaced with '11'.
    ...
    static EnsureSettingsFileExists() {
        if !FileExist(this.SettingsFile) {
            acMsgBox.show("The settings file was not found at:`n"
                . this.SettingsFile 
                . "`nDefault values will be used."
                . "`n`nYou might need to get the INI file from the github.com/kunkel321/autocorrect2 repo."
                ,, 4160 " icon!")
        }
    }
